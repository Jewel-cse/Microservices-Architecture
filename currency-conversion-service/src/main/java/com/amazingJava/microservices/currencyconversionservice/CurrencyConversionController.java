package com.amazingJava.microservices.currencyconversionservice;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversion(@PathVariable String from,
        ...
        ResponseEntity<CurrencyConversion> responseEntity =
                restTemplate.getForEntity("http://localhost:8000/currency-exchange/from/{from}/to/{to}",CurrencyConversion.class,uriVariables);
